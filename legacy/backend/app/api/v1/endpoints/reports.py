    ...
    templates = [
        {
            ...
            "category": "analytics",
            "icon": "chart-line",
            "preview": "/templates/revenue_analysis_preview.png",
            "data_requirements": ["sales_data", "customer_data"],
        ...
        },
        {
            ...
            "description": "Location-based market analysis and competitor insights",
            "category": "marketing",
            "icon": "map",
            "preview": "/templates/market_research_preview.png",
            "data_requirements": ["location_data", "competitor_data"],
            "estimated_time": "10-15 minutes",
            "popularity": 87,
            "tags": ["market", "location", "competitors"]
        },
        {
            ...
            "category": "analytics",
            "icon": "users",
            "preview": "/templates/customer_insights_preview.png",
            "data_requirements": ["customer_data", "transaction_data"],
            "estimated_time": "8-12 minutes",
            "popularity": 78,
            "tags": ["customers", "behavior", "segmentation"]
        },
        {
            ...
            "category": "operations",
            "icon": "cog",
            "preview": "/templates/operational_performance_preview.png",
            "data_requirements": ["operations_data", "staff_data"],
    ...
    shared_reports = [
        {
            ...
            "report_name": "Q4 Revenue Analysis",
        ...
        },
        {
            "share_id": f"share_{uuid.uuid4()}",
            "report_id": f"report_{uuid.uuid4()}",
            "report_name": "Market Research - Downtown",
...
async def export_report(
    ...
    export_data = {
        ...
        "file_size": "3.2MB",
        "download_url": f"/api/v1/reports/{report_id}/download/{uuid.uuid4()}.{export_format}",
