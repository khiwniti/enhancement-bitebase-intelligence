        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-gray-700 font-semibold text-lg">{t('hero.badge')}</span>
              <motion.div
          ...
          >
            {[
              { icon: Shield, label: t('hero.trust.security.label'), color: "from-green-400 to-emerald-500", description: t('hero.trust.security.description') },
              { icon: Globe, label: t('hero.trust.global.label'), color: "from-blue-400 to-cyan-500", description: t('hero.trust.global.description') },
              { icon: Lightning, label: t('hero.trust.analytics.label'), color: "from-yellow-400 to-orange-500", description: t('hero.trust.analytics.description') }
            ].map((item, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                number: 5000,
                suffix: "+",
                label: t('stats.restaurants.label'),
                icon: ChefHat,
            ...
            {[
              {
                ...
                avatar: "👩‍🍳",
                rating: 5,
                quote: t('testimonials.sarah.content')
              },
              {
                ...
                avatar: "👨‍💼",
                rating: 5,
                quote: t('testimonials.michael.content')
              },
              {
                ...
                avatar: "👩‍💻",
                rating: 5,
                quote: t('testimonials.priya.content')
              }
