          ...
          >
            ...
            >
              <motion.div whileHover={scaleOnHover}>
                <Link href={`/${locale}/dashboard`} className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl">
                  {t('hero.cta_primary')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <motion.div whileHover={scaleOnHover}>
                <Link href={`/${locale}/dashboard`} className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl">
                  {t('cta.button')}
                  <ArrowUpRightIcon className="ml-2 h-5 w-5" />
                </Link>
              </motion.div>
