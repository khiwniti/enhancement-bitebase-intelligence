    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">{t('get_started', 'Get Started')}</h1>
          <p className="text-gray-600">{t('description', 'Create your BiteBase Intelligence account')}</p>
        </motion.div>
        ...
        >
          <Card className="bg-white/90 backdrop-blur-xl border border-gray-200 shadow-2xl">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl font-bold text-center">{t('create_account', 'Create Account')}</CardTitle>
              <CardDescription className="text-center">
                {t('subtitle', 'Join thousands of restaurants using AI-powered insights')}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                    {t('agree_to_terms', 'I agree to the')}{' '}
                    <Link href={`/${locale}/terms`} className="text-orange-600 hover:text-orange-500 font-medium">
                      {t('terms_of_service', 'Terms of Service')}
                    </Link>
                    {' '}{t('and', 'and')}{' '}
                    <Link href={`/${locale}/privacy`} className="text-orange-600 hover:text-orange-500 font-medium">
                ...
                >
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        {tCommon('create_account', 'Create Account')}
